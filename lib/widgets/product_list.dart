...
class _ProductListState extends State<ProductList> {
  ...
  Widget build(BuildContext context) {
    //final size = MediaQuery.sizeOf(context); Inherited Modal - read only the particular property(i.e,Size here)
    //Inherited Widget - reads everything inside the class and rebuilds if any thing inside it changes(i.e, if we are using it or not) 
